...
playlist_tracks_df = pd.read_pickle("spotify/likedSongs.pkl")
recommendation_tracks = get_recommendations(sp, playlist_tracks_df[playlist_tracks_df['popularity'].between(70,100)].drop_duplicates(subset='id', keep="first")['id'].tolist()[:10])
